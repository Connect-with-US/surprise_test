...
//         <div className='  h-80 w-full  border-r-4 border-b-4 rounded-2xl border-red-200  '
//         >
        
//         <div className='    h-2  w-11/12 mx-auto  border-t-4 rounded-3xl border-amber-950  '
//         >
...
<footer class="bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-red-900 via-violet-200 to-orange-500">
  <div class="max-w-screen-xl h-60 px-4 py-16 mx-auto mb-2 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <img src={quizLogo}  className="mr-5 h-6  sm:h-9" alt="logo" />
        <p class="max-w-xs mt-4 text-sm text-black">
          Join us and Improve your Desire skills
        </p>
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-black">
            <a class="hover:opacity-75" href> Test Your Skill </a>
            <a class="hover:opacity-75" href> Download Question paper </a>
            <a class="hover:opacity-75" href> Test Yr Students </a>
          </nav>
        </div>
        <div>
          <p class="font-medium">
