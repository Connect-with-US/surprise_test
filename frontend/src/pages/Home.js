...
const Home = () => {
  ...
  return (
    <div className=' '>
      <div className='grid grid-cols-3   w-full h-[288px] mt-3 bg-violet-200 rounded-b-3xl ml-1 mr-1  text-center text-black justify-center place-items-center text-3xl gap-x-8'>
        {/* <LineStyle/> */}
