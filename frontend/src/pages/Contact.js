...
<div>
  ...
  <div class="bg-slate-50 ">
      ...
      <div class="p-5 space-y-5 shadow-xl">
        ...
        <form>
          <div class="shadowai grid grid-cols-2 gap-5">
            <input
              type="text"
              class="border border-gray-500 px-4 py-2 focus:outline-none "
            ...
            <input
              type="email"
              class="border border-gray-500 px-4 py-2 focus:outline-none focus:bgcol-span-2"
              placeholder="Email"
            />
            <input
              type="tel"
              class="border border-gray-500 px-4 py-2 focus:outline-none focus:bg-blue col-span-2"
              placeholder="Phone"
            />
            <textarea
              cols="10"
              rows="5"
              class="border border-gray-500 px-4 py-2 focus:outline-none focus:bg-blue0 col-span-2"
          ...
          <input
            type="submit"
            value="Send Message"
            class="focus:outline-none mt-5 bg-blue-500 hover:bg-blue-700 px-4 py-2 text-white font-bold w-full"
          />
        </form>
      </div>
    </div>
